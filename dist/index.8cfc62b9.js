...
var _formDataJs = require("./modules/formData.js");
...
document.querySelector('.feedback').addEventListener('submit', function(event) {
    ...
    (0, _formDataJsDefault.default)(message);
    alert('Successfully');
});

},{"./modules/formData.js":"kafcE","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"kafcE":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
